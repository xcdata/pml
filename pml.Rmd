...
So the optimal number of rounds is `r best.rounds`.  And the out of sample Error from cross validation is 0.9%.
...
In comparison our Cross Validation estimates the out of sample Error to be 0.9%.
